...
# ./dui/build.sh
clang.exe -g -std=c++17 demo.cpp -o ./build/demo.exe -D DUI_HOT_RELOAD -I "./" ./external/glfw/lib-clang/glfw3.lib -I "C:\Users\Asad\VulkanSdk\1.3.231.1\Include" "C:\Users\Asad\VulkanSdk\1.3.231.1\Lib\vulkan-1.lib"  -I ./external/freetype/include ./external/freetype/debug/freetyped.lib